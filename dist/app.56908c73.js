...
var bar = document.querySelector(".loading-bar-inner");
var counter = document.querySelector(".loading-counter-number");
var c = 0;
var barInterval = setInterval(function () {
  ...
  if (c === 101) {
    ...
    _gsap.default.to(".loading-bar", {
      duration: 5,
      rotate: "90deg",
      left: "1000%"
    });

    _gsap.default.to(".loading-text,.loading-counter", {
      duration: 0.5,
      opacity: 0
    });
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13142" + '/');
